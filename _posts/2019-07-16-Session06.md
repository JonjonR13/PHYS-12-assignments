...
THis failed multiple times because the base of the ball wasnt sticking to the base board/ build board so I had to pause and stick tape to the base and start again to keep the base of the ball from moving. To solve this I used a feature on the slicer by changing the base adhesion method to raft.
<img src="2019-07-18 (1).png" alt="Design Step Ten">
<a href='' download>Cube STL file</a>